	...
	<div class = "background">
		...
		<div class="box">   
			<h2 class = "detailsheading" > 
				<?php			
					$uID = $_SESSION["uID"];
					$sql = "SELECT * FROM pharmacist WHERE PharmacistID = '$uID'";
					$result = $con->query($sql);
						
					if(mysqli_num_rows($result) > 0){
						while( $row = mysqli_fetch_assoc($result) ){
							echo "Pharmacist : ". $row["First_Name"]. " ". $row["Last_Name"];
						}
					}
				?>
			</h2> 
		...
		<button class="btn"> <a href="pharmacistedit.php"> Edit profile <a></button>
		...
		<button class="btn4"> <a href="pharmacy_home.php"> Pharmacist management <a></button>
