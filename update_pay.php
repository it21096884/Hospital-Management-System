  ...
  display: inline-block;
	...
	<div id="imghalf">
		...
		<div id="div1">
				...
				<h1 style= "color:black; text-decoration: underline;"> <center> Update Records </center></h1>
				</div>
				<br><br>
				
				<center><lable for ="id">  <b>PharmacyID </b></label>
				&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
				&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp	
				<input type="text" name="phid" align="left" > </center>
				<br><br>	


				<center><lable for ="id">  <b>Total_Amount</b></label>
				&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
				&nbsp&nbsp&nbsp&nbsp&nbsp
				<input type="text" name="ttamount"></center><br><br>
				
				
				<center><lable for ="id">  <b>Status</b></label>
				&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
...
 				  <input type="radio"  name="status" value="Delivered">
				 <label for="delivered">Delivered</label></center>
	...
	$PharmacyID = $_POST['phid'];
	$total_amount =$_POST['ttamount'];
	$status =$_POST['status'];
	
	//insert query
	$sql = "UPDATE `pharmacy` SET total_amount='$total_amount', status='$status'  WHERE PharmacyID = '$PharmacyID'";
