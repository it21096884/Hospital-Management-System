...
$sql = "SELECT d.DoctorID  , d.Frist_Name ,d.Last_Name, d.Specialization ,d.Email
		FROM doctor d 
...
if($result -> num_rows > 0)
{
	...
	echo "<th> DoctorID </td> <th> Frist_Name </th> <th> Last_Name </th>  <th> Specialization</th>  <th> Email</th>   ";
...
?>
	...
	<div class="contain1">
		<a href="create.php">
		<input type="submit" class= "button" value="CREATE" name="btnsubmit" class="button">
		</a>
