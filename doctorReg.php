...
<html>
	...
	<div class = "background">
		<h2 class = "loginheading" >Doctor Registration</h2> 
		<div class="login">    
			<form id="login" method="POST" action="doctorRegister.php">    
				...
				<label style = 'font-family: "Source Sans Pro"; font-size: 20px;'> Doctor specialization : </label><br><br>   
