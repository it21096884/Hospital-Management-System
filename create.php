...
form .btnl{
	...
	<br><br>
	<body>
    <center><h1>CREATE APPOINTMENTS</h1></center>
    <center>
    <div class="container">
...
<center> Status</br> <input type="text" name="Status"><br></center>
</br> </br> </br>
<center> Price </br> <input type="text" name="price"><br></center>
</br> </br> </br>
...
<?php
	...
	$sql = "INSERT INTO appointment (AppointmentID,Appointment_Time,Appointment_Date, Status,price  ) VALUES ('$AppointmentID','$Appointment_Time','$Appointment_Date', '$Status', '$price')";
	if($con -> query($sql))
	{
