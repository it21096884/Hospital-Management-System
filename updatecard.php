...
<html>
	...
	<h2 class = "loginheading" >Update Card</h2> 
		<div class="addcards">    
	...
	<div class = "background">
		<div class = "container">
			<div class = "box">
				<div class ="card" >
				<form id="add" method = "POST" action="update.php" >    
				...
				<input type="number" name="cvv" id="cvv" placeholder="Enter CVV" minlength="3" required>    
				<br><br>
