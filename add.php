...
$sql = "SELECT d.Specialization,  d.Last_Name , d.DoctorID, a.Appointment_Time , a.Appointment_Date  
...
if($result -> num_rows > 0)
{
	...
	echo "<th> Specialization </td>  <th> Last_Name </th> <th> DoctorID </th> <th>  Appointment_Time
	</th> <th> Appointment_Date </th>  ";
...
?>
	...
	<div class="contain1">
		...
		<a href="new.php">
		<input type="submit" class= "button" value="NEW" name="btnsubmit" class="button">
		</a>
		</div>
		</center>
<br><br><br>
